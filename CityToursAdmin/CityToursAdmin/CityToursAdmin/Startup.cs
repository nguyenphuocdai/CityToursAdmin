...
using CityToursAdmin.ViewModels;
using CityToursAdmin.Helpers;
using CityToursAdmin.Authorization;
...
namespace CityToursAdmin
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("CityToursAdmin"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "CityToursAdmin API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "CityToursAdmin API V1");
            });
